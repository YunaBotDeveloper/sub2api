...
- **Built-in Payment System** - Supports SePay (Vietnam) bank transfer, Napas, and card payments for user self-service top-up, no separate payment service needed ([Configuration Guide](docs/PAYMENT.md))
