    ...
    <div v-if="group" class="space-y-4">
      ...
      <div class="border-b border-border pb-4">
        ...
        <div v-if="localEntries.length > 0" class="mt-3 flex items-center gap-3 border-t border-border pt-3">
          <span class="text-xs font-medium text-fg-muted">{{ t('admin.groups.batchAdjust') }}</span>
          <div class="flex items-center gap-1.5">
            ...
            <input
              ...
              min="0"
              autocomplete="off"
              class="hide-spinner input w-20 px-2 py-1 text-right tabular-nums"
              placeholder="0.5"
            />
            <button
              type="button"
              ...
              <table class="table min-w-max">
                <thead class="sticky top-0 z-[1]">
                  <tr>
                    ...
                    <th class="text-right">{{ t('admin.groups.columns.rateMultiplier') }}</th>
                    <th v-if="showFinalRate" class="text-right">{{ t('admin.groups.finalRate') }}</th>
                    <th class="w-10"></th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  >
                    ...
                    <td v-if="showFinalRate" class="whitespace-nowrap text-right font-semibold tabular-nums text-accent-strong">
