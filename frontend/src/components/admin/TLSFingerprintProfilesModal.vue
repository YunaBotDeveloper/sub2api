        ...
        <table class="table">
          ...
          <tbody>
            <tr v-for="profile in profiles" :key="profile.id">
              <td class="px-3 py-2">
                <div class="font-medium text-fg text-sm">{{ profile.name }}</div>
              </td>
              <td class="px-3 py-2">
                <div v-if="profile.description" class="text-sm text-fg-muted max-w-xs truncate">
                  {{ profile.description }}
                </div>
              ...
              <td class="px-3 py-2">
                <Icon
                  ...
                  size="sm"
                  :class="profile.enable_grease ? 'text-success' : 'text-fg-subtle'"
                />
              </td>
              <td class="px-3 py-2">
                <div v-if="profile.alpn_protocols?.length" class="flex flex-wrap gap-1">
                  ...
                  <span v-if="profile.alpn_protocols.length > 3" class="text-xs text-fg-muted">
        ...
        <div>
          ...
          <div class="mt-1 flex items-center gap-2">
            ...
            <p class="text-xs text-fg-muted">
              ...
              <a href="https://tls.sub2api.org" target="_blank" rel="noopener noreferrer" class="text-accent hover:text-accent-strong underline">{{ t('admin.tlsFingerprintProfiles.form.openCollector') }}</a>
            </p>
          </div>
        </div>
        ...
        <div class="flex items-center gap-3">
          <button
            ...
            :class="[
              ...
              form.enable_grease ? 'bg-accent' : 'bg-border'
            ]"
          >
            <span
              :class="[
