  ...
  >
    <form id="import-data-form" class="space-y-4" @submit.prevent="handleImport">
      ...
      <div>
        ...
        <div
          class="flex items-center justify-between gap-3 rounded-sm border border-dashed px-4 py-3 transition-colors"
          :class="dragActive
        ...
        >
          <div class="min-w-0">
            <div class="truncate text-sm text-fg" :title="fileListTitle">
