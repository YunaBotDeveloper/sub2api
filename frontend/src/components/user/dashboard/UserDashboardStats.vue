<template>
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div v-if="!isSimple" class="card p-4">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-success-600 dark:text-success-400">${{ formatBalance(balance) }}</p>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xs text-success-600 dark:text-success-400">{{ stats?.active_api_keys || 0 }} {{ t('common.active') }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-lg bg-success-100 p-2 dark:bg-success-900/30">
          <Icon name="chart" size="md" class="text-success-600 dark:text-success-400" :stroke-width="2" />
        </div>
        <div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-lg bg-gray-100 p-2 dark:bg-gray-900/30">
          <Icon name="dollar" size="md" class="text-gray-600 dark:text-gray-400" :stroke-width="2" />
        </div>
        <div>
          <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.todayCost') }}</p>
          <p class="text-xl font-bold text-gray-900 dark:text-white">
            <span class="text-gray-600 dark:text-gray-400" :title="t('dashboard.actual')">${{ formatCost(stats?.today_actual_cost || 0) }}</span>
          ...
          <p class="text-xs">
            ...
            <span class="text-gray-600 dark:text-gray-400" :title="t('dashboard.actual')">${{ formatCost(stats?.total_actual_cost || 0) }}</span>
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-lg bg-warning-100 p-2 dark:bg-warning-900/30">
          <Icon name="cube" size="md" class="text-warning-600 dark:text-warning-400" :stroke-width="2" />
        </div>
        <div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-lg bg-gray-100 p-2 dark:bg-gray-900/30">
          <Icon name="bolt" size="md" class="text-gray-600 dark:text-gray-400" :stroke-width="2" />
        </div>
        <div class="flex-1">
          ...
          <div class="flex items-baseline gap-2">
            <p class="text-sm font-semibold text-gray-600 dark:text-gray-400">{{ formatTokens(stats?.tpm || 0) }}</p>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-lg bg-danger-100 p-2 dark:bg-danger-900/30">
          <Icon name="clock" size="md" class="text-danger-600 dark:text-danger-400" :stroke-width="2" />
        </div>
        <div>
