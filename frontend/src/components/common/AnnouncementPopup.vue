<template>
  <Teleport to="body">
    <Transition name="popup-fade">
      ...
      >
        <div
          class="w-full max-w-[680px] overflow-hidden rounded-lg bg-white shadow-2xl ring-1 ring-black/5 dark:bg-dark-800 dark:ring-white/10"
          @click.stop
        >
          <!-- Header with warm gradient -->
          <div class="relative overflow-hidden border-b border-warning-100/80 bg-warning-50/80 px-8 py-6 dark:border-dark-700/50 dark:bg-warning-900/20">
            <!-- Decorative background -->
            <div class="absolute right-0 top-0 h-full w-64 bg-warning-100/30 dark:bg-warning-900/20"></div>
            <div class="absolute -right-8 -top-8 h-32 w-32 rounded-full bg-warning-400/20 blur-3xl"></div>
            <div class="absolute -left-4 -bottom-4 h-24 w-24 rounded-full bg-warning-400/20 blur-2xl"></div>

            <div class="relative z-10">
              <!-- Icon and badge -->
              <div class="mb-3 flex items-center gap-2">
                <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-warning-500 text-white shadow-lg">
                  <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                  </svg>
                </div>
                <span class="inline-flex items-center gap-1.5 rounded-lg bg-warning-500 px-2.5 py-1 text-xs font-medium text-white shadow-lg">
          ...
          <div class="max-h-[50vh] overflow-y-auto bg-white px-8 py-8 dark:bg-dark-800">
            <div class="relative">
              <div class="absolute left-0 top-0 bottom-0 w-1 rounded-full bg-warning-500"></div>
              <div class="pl-6">
                <div
          ...
          <div class="border-t border-gray-100 bg-gray-50/50 px-8 py-5 dark:border-dark-700 dark:bg-dark-900/30">
            <div class="flex items-center justify-end">
              <button
                ...
                class="rounded-xl bg-warning-500 px-6 py-2.5 text-sm font-medium text-white shadow-lg transition-all hover:scale-105"
              >
