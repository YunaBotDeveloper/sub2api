<template>
  <div class="flex items-start gap-4">
    ...
    <div class="flex-shrink-0">
      <div
        class="flex items-center justify-center overflow-hidden rounded-sm border-2 border-dashed border-border-strong bg-surface-sunken"
        :class="[previewSizeClass, { 'border-solid': !!modelValue }]"
      >
        <!-- SVG mode: render inline -->
        <span
          v-if="mode === 'svg' && modelValue"
          class="text-fg-muted [&>svg]:h-full [&>svg]:w-full"
