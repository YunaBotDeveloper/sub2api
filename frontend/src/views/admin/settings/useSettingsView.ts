...
export type OpenAIAdvancedSchedulerOverrideKey =
...
export type OpenAIAdvancedSchedulerEffectiveKey =
...
export type ForwardedClientIpHeaderResult = "added" | "duplicate" | "invalid" | "full";
...
export interface AffiliateModalState {
  open: boolean;
  mode: "add" | "edit";
  saving: boolean;
  userQuery: string;
...
export function useSettingsView() {
  ...
  return {
    ...
    CUSTOM_PAGE_IFRAME_HOST_PATTERN,
    MAX_CUSTOM_PAGE_IFRAME_HOSTS,
    normalizeCustomPageIframeHost,
    customPageIframeHostEntries,
    customPageIframeNormalizedHosts,
    customPageIframeInvalidEntry,
    customPageIframeState,
    customPageIframeHostsPayload,
    adminApiKeyLoading,
    adminApiKeyExists,
    adminApiKeyMasked,
...
export type SettingsViewContext = ReturnType<typeof useSettingsView>;
