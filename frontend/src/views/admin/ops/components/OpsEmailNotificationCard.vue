      ...
      <div class="rounded-lg bg-gray-50 p-4 dark:bg-dark-700/50">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div class="md:col-span-2">
            ...
            <p v-if="alertRecipientError" class="mt-1 text-xs text-danger-600 dark:text-danger-400">{{ alertRecipientError }}</p>
            <div class="mt-2 flex flex-wrap gap-2">
              ...
              >
                ...
                <button
                  type="button"
                  class="text-accent-700/80 hover:text-accent-900 dark:text-accent-300"
      ...
      <div class="rounded-lg bg-gray-50 p-4 dark:bg-dark-700/50">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div class="md:col-span-2">
            ...
            <p v-if="reportRecipientError" class="mt-1 text-xs text-danger-600 dark:text-danger-400">{{ reportRecipientError }}</p>
            <div class="mt-2 flex flex-wrap gap-2">
              <span
