        ...
        >
          ...
          <template #cell-groups="{ row }">
            <div v-if="allGroups.length > 0" class="flex flex-col gap-1">
              ...
              >
                <Icon name="shield" size="xs" class="h-3.5 w-3.5 text-gray-500 dark:text-gray-400" />
                <span class="font-medium text-gray-600 dark:text-gray-400">{{ getUserGroups(row).exclusive.length }}</span>
          ...
          <template #cell-balance="{ value, row }">
            <div class="flex items-center gap-2">
              ...
              <button
                ...
                class="rounded px-2 py-0.5 text-xs font-medium text-success-600 transition-colors hover:bg-success-50 dark:text-success-400 dark:hover:bg-success-900/20"
            ...
            <div class="flex items-center gap-1.5">
              <span
                :class="[
                  ...
                  value === 'active' ? 'bg-success-500' : 'bg-danger-500'
                ]"
              ></span>
            ...
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                :class="[
                  ...
                  row.status === 'active'
                    ? 'hover:bg-warning-50 hover:text-warning-600 dark:hover:bg-warning-900/20 dark:hover:text-warning-400'
                    : 'hover:bg-success-50 hover:text-success-600 dark:hover:bg-success-900/20 dark:hover:text-success-400'
                ]"
              >
          ...
          <template v-for="user in users" :key="user.id">
            <template v-if="user.id === activeMenuId">
              ...
              <button
                ...
                class="flex w-full items-center gap-2 px-4 py-2 text-sm text-danger-600 hover:bg-danger-50 dark:text-danger-400 dark:hover:bg-danger-900/20"
              >
