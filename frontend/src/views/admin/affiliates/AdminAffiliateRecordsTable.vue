      ...
      <template #table>
        ...
        >
          ...
          <template #cell-invitee="{ row }">
            <span v-if="row.invitee_id == null" class="text-fg-subtle">-</span>
            <UserCell
              v-else
              :id="row.invitee_id"
          ...
          <template #cell-order="{ row }">
            <span v-if="row.order_id == null" class="text-fg-subtle">-</span>
          ...
          <template #cell-pay_amount="{ row }">
            <span v-if="row.pay_amount == null" class="text-fg-subtle">-</span>
            <span v-else class="tabular-nums text-fg">¥{{ formatAmount(row.pay_amount) }}</span>
          </template>
