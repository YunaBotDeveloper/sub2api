      ...
      <transition name="fade">
        ...
        >
          ...
          >
            <div class="space-y-3">
              <div class="space-y-1">
                <p class="text-body font-bold text-accent-strong">
              ...
              <label
                ...
                class="flex items-start gap-3 border-t border-border pt-3 text-body"
              >
              ...
              >
                ...
                <span class="space-y-1">
                  ...
                  <span class="block break-all text-fg-muted">
                    {{ suggestedAvatarUrl }}
                  </span>
                </span>
              </label>
