<template>
  <div class="min-h-screen bg-surface-sunken px-4 py-10">
    <div class="mx-auto max-w-2xl">
      <div v-if="isProcessing" class="card p-6 text-center">
        ...
        <h1 class="mt-4 text-h2 font-bold text-accent-strong">
      ...
      <div v-else-if="needsRegistrationCompletion" class="card p-6">
        ...
        <div class="mt-6 space-y-4">
          ...
          <p v-if="registrationError" class="text-body text-danger">
            {{ registrationError }}
          </p>
          <button
        ...
        <div class="mt-6 space-y-4">
          <div>
            ...
            <div class="flex gap-2">
              <input class="input flex-1 font-mono text-body" :value="code" readonly />
          ...
          <div>
            ...
            <div class="flex gap-2">
              <input class="input flex-1 font-mono text-body" :value="state" readonly />
              <button
          ...
          <div>
            ...
            <div class="flex gap-2">
              <input class="input flex-1 font-mono text-meta" :value="fullUrl" readonly />
              <button
                class="btn btn-secondary"
                type="button"
                :disabled="!fullUrl"
