        ...
        <div>
          <div class="mb-1.5 flex items-center justify-between">
            ...
            <router-link
              ...
              to="/forgot-password"
              class="text-label font-medium text-accent hover:text-accent-strong"
            >
          ...
          <div class="relative">
            ...
            <button
              ...
              :disabled="authActionDisabled"
              class="absolute inset-y-0 right-0 flex items-center rounded pr-3 text-fg-subtle transition-colors hover:text-fg focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
            >
