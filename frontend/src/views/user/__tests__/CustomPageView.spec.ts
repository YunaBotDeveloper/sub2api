...
const { appStore } = vi.hoisted(() => ({
  appStore: {
    ...
    cachedPublicSettings: { custom_menu_items: [{ id: 'docs', url: 'https://example.com/docs', pass_token: true }] },
  },
}))
...
describe('custom page open button', () => {
  beforeEach(() => {
    appStore.cachedPublicSettings.custom_menu_items = [{ id: 'docs', url: 'https://example.com/docs', pass_token: true }]
