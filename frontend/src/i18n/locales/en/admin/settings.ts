export default {
    settings: {
      ...
      payment: {
        ...
        subscriptionUsdToCnyRate: 'Subscription Exchange Rate',
        subscriptionUsdToCnyRateHint:
          'Gateway currency charged per 1 USD of plan price (e.g. 25000 VND). 0 or empty = disabled, plan price is charged as-is. When enabled, all plan prices must be set in USD',
        ...
        exchangeRateMarkup: 'Exchange Rate Markup',
        exchangeRateMarkupHint: 'Added on top of the Vietcombank sell rate when converting between USD and the gateway currency. 0 means the published rate is used as-is.',
        exchangeRateMaxAge: 'Exchange Rate Max Age (hours)',
        exchangeRateMaxAgeHint: 'If the rate provider is unreachable, the last cached rate is used until it reaches this age; after that, top-up orders are blocked rather than priced against an unknown rate. Default 24.',
        ...
        nowPaymentsWebhookHint: 'Add the following URL as the IPN callback in the NOWPayments dashboard (Settings -> Payments -> IPN), and paste the IPN secret it generates below:',
