export default {
    ...
    groups: {
      ...
      openaiFast: {
        ...
        ultrafastHint: '强制该分组的 OpenAI 请求使用 service_tier=ultrafast。上游只有 gpt-5.6-sol 提供该档位，请配合渠道模型限制把分组限定到该模型。优先级高于强制 Fast，但仍会被禁用 Fast 覆盖；免费 Fast 不会为该档位打折。已建立的 WebSocket 会话需重连后生效。'
      },
