export default {
    ops: {
      ...
      diagnosis: {
        ...
        slaCriticalAction: '紧急排查错误原因与延迟，必要时采取限流保护',
        slaLow: 'SLA 低于目标 ({sla}%)',
        slaLowImpact: '需要关注服务质量',
        slaLowAction: '分析SLA下降原因，优化系统性能',
        // Health score diagnostics
        healthCritical: '综合健康评分过低 ({score})',
        healthCriticalImpact: '多个指标可能同时异常，建议优先排查错误率与延迟',
        healthCriticalAction: '全面检查系统状态，优先处理 critical 级别问题',
      ...
      runtime: {
        ...
        silencing: {
          ...
          untilHint: '留空表示仅切换静默状态、不设置截止时间（不推荐）。',
          reason: '原因',
