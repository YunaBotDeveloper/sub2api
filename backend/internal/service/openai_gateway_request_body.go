...
// validateUpstreamBaseURL 校验上游账号配置的 base_url。
// 实现与 GatewayService / AntigravityGatewayService 共用，nil cfg 的 fail-safe
// 取舍见 validateUpstreamBaseURLWithConfig 的注释。
